...
public class FxManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        else
        {
            ...
            Instance = this;
            DontDestroyOnLoad(gameObject); // 이 함수는 Scene이 변경되어도 사라지지 않게 한다.
    ...
    public void PlayFx(Transform targetTransform, FxType targetFx, Vector3 Offset) // 싱글톤된 함수 어디서든 Fx를 불러올 수 있게 함.
    {
